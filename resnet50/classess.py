"""Labels for imagenet classess"""

IMAGENET_LABELS = {  # pylint: disable=too-many-lines
    0: "tench, Tinca tinca",
    ...
    "pit bull terrier",  # pylint: disable=bad-continuation
    ...
    " snake doctor, mosquito hawk, skeeter hawk",  # pylint: disable=bad-continuation
    320: "damselfly",
    321: "admiral",
    ...
    " Ovis canadensis",  # pylint: disable=bad-continuation
    350: "ibex, Capra ibex",
    351: "hartebeest",
    ...
    " trash barrel, trash bin",  # pylint: disable=bad-continuation
    ...
    "automated teller, automatic teller, ATM",  # pylint: disable=bad-continuation
    481: "cassette",
    482: "cassette player",
    483: "castle",
    484: "catamaran",
    ...
    " parviflorum",  # pylint: disable=bad-continuation
    987: "corn",
    988: "acorn",
